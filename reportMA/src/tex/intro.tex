...
\begin{figure}[h!]
    ...
    \label{fig:main-loop}
\end{figure} \newline
Then there are lots of different functions, which do some service tasks. TODO: continue description of the functions inside...
...
\begin{itemize}
    \item An intersection of a ray and a line is calculated. The initial point of the ray is a sensor position and direction. The line is a wall of the track.
    \item If the intersection was found, then we calculate the distance between the sensor and intersection line.
\end{itemize}
...
\end{itemize}
After an execution of this function, the outgoing data is ready to be used by the graphical part of the simulator and during the next execution step.

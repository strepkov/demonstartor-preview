...
The simulator environment consist of the visual and mathematical model. The visual means the graphic representation that can be seen in the browser. The mathematical one, it is the model base on which is built the graphical representation.
\begin{figure}[h!]
    \centering
...
\begin{figure}[h!]
    ...
    \caption{The simulator class diagram.}

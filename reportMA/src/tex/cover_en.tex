...
\begin{flushleft}
  {\fontfamily{phv}  
    ...
    {\LARGE \textbf{Development of Web Playground}\\} 
    {\LARGE \textbf{for Component and Connector Models}\\} 
    \emptyLine % Replace with \emptyLine if title is shorter
    \emptyLine % Replace with \emptyLine if title is shorter
    \vspace{3em}
    ...
    \vspace{1em}
    {\Large \textbf{2nd Examiner: Prof.\ Dr.\ H. Lichter }\\}
    \vspace{1em} 
